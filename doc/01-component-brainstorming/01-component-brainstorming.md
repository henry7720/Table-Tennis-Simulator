...
I like math, data analytics, cybersecurity, linux, VS Code. I also like finance industry, etc. Oh, and I love Table Tennis.
...
- Component Design #1: Table Tennis Score Keeper (Player object with score properties) w/ Web Server for Live Updates)
  ...
  - **Kernel Methods**:  `int getScore()`, `void setScore(int new)`, `void getRoundNumber()`, `void getTotalWins()`, `void startServer()`
  - **Secondary Methods**: `int addPoint()`, `int newRound()`, `void updateWebView()`, `void determineWinner(Player one, Player two)`

- Component Design #2: Silver Spot Price Checker Host (live web view)
  - **Description**: This component would use a pre-defined API for silver spot price checking to get the current price and price of the last 30 days and generate page on a webserver.
  - **Kernel Methods**: `void startServer()`,  `int getCurrentPrice()`, `void getPastThirtyDays()`
  - **Secondary Methods**: `boolean isPriceAvailable()`, `void updateWebViewTable()`, `void saveMonthData()`

- Component Design #3: Personal Health Tracker
  - **Description**: This would help a person track sleep and provide recommendations through an web-app interface given input.
  - **Kernel Methods**: `void setHoursExercisePerWeek()`, `void setHoursSlept()`, `int getHoursExercisePerWeek()`, `int getHoursSlept()`
  - **Secondary Methods**: `void updateWebView()`, `void provideRecommendations()`, `int addDayData()`
